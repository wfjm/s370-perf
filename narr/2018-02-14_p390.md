...
- First [P/390](sysinfo_p390.md) data with the new extended set of tests.
- First s370_perf data from a _real_ CPU.
- The T900 tests were at this time not yet integrated in s370_perf but
  handled by a separate code, the results are therefore split in two files.

### Findings <a name="find"></a>
- the test reproducibility is excellent, the 50% width is for most tests
  0.4% or better.
