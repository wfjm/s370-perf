...
| Summaries | [p390 over time](sum_2018-02-14_p390_and_2018-02-14.dat) - _compare with P/390 2018-02-14 data (ratio sorted)_ |
|           | [S/360-70 vs P/370](sum_2018-04-16_p390_and_s360-70.dat) - _absolute instruction time (ratio sorted)_ |
...
- **Instruction timing**
  ...
  - fast floating point arithmetic, `ADR` and `AER` in 6 cycles, see
    [section floating arithmetic](#user-content-find-cycle-float).

#### 2018-02-14 vs 2018-04-16 data <a name="find-last"></a>
Most instruction times agree to better than 0.5%, see
[ratio sorted data comparison](sum_2018-02-14_p390_and_2018-02-14.dat).
...
about 15%, see
[section in narrative](2018-02-14_p390.md.html#user-content-find-trw50).
This is not observed again, the w50 values for `TR` and `TRT` are very
...
#### Floating Arithmetic <a name="find-cycle-float"></a>
Floating point is quite fast. Addition, subtraction and compare execute
in 6 cycles for single and double precision floats. Multiply and divide
